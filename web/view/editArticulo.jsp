                ...
                <div class="row justify-content-center">
                    <div class="col-lg-7">
                        <div class="card shadow-lg border-0 rounded-lg mt-5">
                            <div class="card-header"><h3 class="text-center font-weight-light my-4">Editar Articulo</h3></div>
                            <div class="card-body">
                                <form action="ControllerArticulo" id="myForm" method="post">
                                     ...
                                     <div class="row mb-3">
                                        <div class="col-md-6">
                                            <div class="form-floating mb-3 mb-md-0">
                                                <input class="form-control" id="Nombres" name="NomArticulo" type="text" placeholder="Nombre Articulo" value="${art.getNombreArticulo()}">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <div class="form-floating mb-3 mb-md-0">
                                                <input class="form-control" id="Nombres" name="DistritoArticulo" type="text" placeholder="Distrito Articulo" value="${art.getDistritoArticulo()}">
                                                <label for="inputFirstName">*Distrito</label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <input class="form-control" id="PreferenciaArticulo" name="PreferenciaArticulo" type="text" placeholder="Preferencia"  value="${art.getPreferenciaArticulo()}">
                                                <label for="inputLastName">*Preferencia</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="text" name="TituloArticulo" type="text" placeholder="Titlo de Articulo"  value="${art.getTituloArticulo()}">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <div class="form-floating mb-3 mb-md-0">
                                                <input class="form-control" id="Distrito" name="EstadoArticulo" type="text" placeholder="Estado de articulo" value="${art.getEstadoArticulo()}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating mb-3 mb-md-0">
                                                <input class="form-control" id="Distrito" name="DescripcionArticulo" type="text" placeholder="Descripcion de Articulo" value="${art.getDescripcionArticulo()}">
                                    ...
                                    <div class="mt-4 mb-0">
                                        <div class="d-grid">
                                            <input type='hidden' name="accion" value="updateArticulo">
                                            <input type='hidden' name="IdArticulo" value="${art.getIdArticulo()}">
                                            <input type='hidden' name="IdUsuario" value="${art.getIdUsuario()}">
                                            
                                            <input class="btn btn-primary btn-block" onclick='submitDetailsForm()' type="submit" name="load" value="Actualizar">
